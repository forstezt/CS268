<%@ Page Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="EditProduct.aspx.cs" Inherits="EditProduct" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="Main" Runat="Server">
    <asp:GridView ID="gvProduct" runat="server" AutoGenerateColumns="False" 
        ...
        <Columns>
            <asp:TemplateField ShowHeader="False">
                <EditItemTemplate>
                    <asp:LinkButton ID="LinkButton1" runat="server" CausesValidation="True" 
                                    ...
                                    OnClientClick="return confirm('Confirm update');"></asp:LinkButton>
                    &nbsp;
            ...
            <asp:BoundField DataField="prod_id" HeaderText="ID" InsertVisible="False" ReadOnly="True" SortExpression="prod_id" >
