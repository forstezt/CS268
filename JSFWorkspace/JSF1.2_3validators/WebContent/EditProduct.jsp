         ...
         <h:form>
            <h:dataTable value="#{productutils.productlist}" 
               ...
               <h:column>
                  ...
                  <h:inputText value="#{row.prod_desc}" rendered="#{row.editable}" size="30" required="true"/>
                  <!-- ignore the errors related to not row.editable - this works -->
               ...
               <h:column>
                  ...
                  <h:inputText value="#{row.prod_cost}" rendered="#{row.editable}" size="10" required="true"/>
               ...
               <h:column>
                  ...
                  <h:inputText value="#{row.prod_price}" rendered="#{row.editable}" size="10" required="true"/>
